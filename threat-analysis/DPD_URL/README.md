...
**Notes:** The message was received at 17:45 on 04/05/2026 from `lindadavidson6243@gmail.com`. A legitimate DPD notification would never originate from a personal Gmail address. The message was treated with suspicion as no parcels had been ordered by the recipient. Further red flags included the structure of the URL and the unusual instructions provided on how to interact with it.
...
**Body:**
> This is a follow-up concerning your package currently in transit. Our driver, Daniel Hughes (ID: 153927), tried to deliver your parcel yesterday at 3:15 PM. Delivery remains pending because a signature is necessary and the address information requires a quick review.
>
> Please confirm your shipping details and set your delivery requirements within 24 hours via this protected link: `hxxps://www.dpdlocakqf[.]cyou/com`
>
> Simply reply with "Y" and refresh your page to proceed. If the link is inaccessible, please copy and paste the address directly into your browser.
...
|---|---|
| Urgency / deadline | "within 24 hours" |
| Fake authority | Fabricated driver name and ID (Daniel Hughes, ID: 153927) |
| Fear of consequence | Implied risk of parcel being returned to sender if no action taken |
...
### Key Findings — Suspicious Behaviour Detected
...
![Cuckoo Sandbox Results](./results.png)
...
|---|---|---|
| [T1566](https://attack.mitre.org/techniques/T1566/) | Phishing | URL designed to impersonate legitimate brand via SMS/email |
| [T1055](https://attack.mitre.org/techniques/T1055/) | Process Injection | PID 1900 injected into PID 2796 via `NtResumeThread` |
| [T1562](https://attack.mitre.org/techniques/T1562/) | Impair Defences | Memory protection changed in stages to avoid triggering RWX detection |
...
- Report to DPD UK directly so they are aware of the impersonation
- Submit to [Google Safe Browsing](https://safebrowsing.google.com/safebrowsing/report_phish/)
- Report to the [NCSC](https://www.ncsc.gov.uk/section/about-this-website/report-scam-website) if in the UK
